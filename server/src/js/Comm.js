/*
    Comm (Communication)
        * holds constant IDs shared between the server and client  
...
const OPC = {
    ...
    INSTANCE_ENTER:         17,
    INSTANCE_EXIT:          18,
    PORTAL_NODE_CREATE:     19,
    PORTAL_NODE_DELETE:     20,
    BATTLE_NODE_CREATE:     21,
    BATTLE_NODE_DELETE:     22,
    BATTLE_ENTER:           23,
    BATTLE_EXIT:            24,
    BATTLE_PLAYERS_TURN:    25,
